...
void plot_hitn_compareBeam_gamma(){
    //gROOT->Reset();
    ...
    //string beamEnergy[] = {"100MeV", "200MeV", "500MeV"};//, "1GeV", "2GeV", "5GeV", "8GeV", "11GeV"};
    string beamEnergy[] = {"1GeV", "2GeV", "5GeV", "8GeV", "11GeV"};
    ...
    c1->SaveAs(Form("./plots/%s/%s_%s2.pdf",config.c_str(), geometry.c_str(),particle.c_str()));
}
